 ...
 */
final class Version20200720071305 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE fournisseur (id INT AUTO_INCREMENT NOT NULL, fournisseur VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE produit ADD genre_id INT NOT NULL, ADD fournisseur_id INT NOT NULL, ADD editeur_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_29A5EC273375BD21 ON produit (editeur_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_29A5EC273375BD21 ON produit');
